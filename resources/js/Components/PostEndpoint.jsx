                            ...
                            {param.type === "array" ? (
                                <>
                                    {(body[param.name] || []).map((item, idx) => (
                                        <div key={idx} className="flex gap-2 mb-2 items-center">
                                            <input
                                                ...
                                                placeholder={param.description}
                                                className="flex-grow border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-400 transition"
                                            />
                                            <button
                                    ...
                                    <button
                                        ...
                                        type="button"
                                        className="text-white bg-green-600 rounded-lg px-4 py-2 hover:bg-green-700 transition text-sm"
                                    >
                                        + Adicionar item
                                    </button>
                                </>
